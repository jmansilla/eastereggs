...
class SOGroup(models.Model):
    ...
    wasted_time = models.IntegerField(default=0, editable=False, help_text="Total wasted time accumulated in minutes (rounded)")
    ...
    def __str__(self) -> str:
        return f'Grupo {self.repo_name}: {self.group_name}'
    ...
    def handle_defeat(self, user_id):
        if not self.challenge_won:
            ...
            self.save()
        return self, self._build_message_to_user(f"Congratulations. Challenge won at {self.challenge_won_timestamp}")
